# Contributing to `haldensify` development

We, the authors of the `haldensify` R package, use the same guide as is used for
...
The goal of this guide is to help you get up and contributing to `haldensify` as
...
To contribute a change to `haldensify`, you follow these steps:
...
1.  __Motivation__. Your pull request should clearly and concisely motivates the
   ...
   `haldensify` comes out it's easy for users to see what's changed. Add your
...
3.  __Use `haldensify` coding style__. To do so, please follow the [official
    ...
    into the code. If you're modifying existing `haldensify` code that doesn't
